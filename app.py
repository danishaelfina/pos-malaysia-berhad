...
# Provide the raw GitHub content URL to the PDF file
pdf_file_url = "https://github.com/danishaelfina/pos-malaysia-berhad/blob/main/Tell%20me%20about%20yourself.pdf"

# Create a hyperlink to the PDF file
pdf_link = f'<a href="{pdf_file_url}" target="_blank">Open PDF</a>'

# Display the hyperlink using st.markdown
